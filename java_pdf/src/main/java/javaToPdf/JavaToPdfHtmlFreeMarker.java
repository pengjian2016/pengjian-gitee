...
public class JavaToPdfHtmlFreeMarker {
    ...
    private static final String DEST = PathUtil.getDemoFilePath()+"HelloWorld_CN_HTML_FREEMARKER.pdf";
    ...
    static {
        ...
        //freemarker的模板目录
        try {
            freemarkerCfg.setDirectoryForTemplateLoading(new File(PathUtil.getTemplatePath()));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
